...
namespace WebAplicacion.Controllers
{
    ...
    public class DatesController : ControllerBase
    {
        ...
        /// </summary>
        private readonly IDatesRepository repository;
        /// <summary>
        /// Logger para registrar en consola algun error o estados success
        /// </summary>
        private readonly ILogger<DatesController> logger;

        /// <summary>
        /// Constructor para la clase <see cref="DatesController"/>
        /// </summary>
        /// <param name="repository"></param>
        public DatesController(IDatesRepository repository, ILogger<DatesController> logger)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Create(Dates data)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update(int id, Dates data)
        {
            if (id < 0)
