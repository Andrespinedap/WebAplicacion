...
namespace WebAplicacion.Controllers
{
    ...
    [ApiController]
    public class Maintenance_HistoryController : ControllerBase
    {
        /// <summary>
        /// Implementa los metodos de comunicación para interactuar con la base de datos
        /// </summary>
        private readonly IMaintenance_HistoryRepository repository;
        /// <summary>
        /// Logger para registrar en consola algun error o estados success
        /// </summary>
        private readonly ILogger<Maintenance_HistoryController> logger;

        /// <summary>
        /// Constructor para la clase <see cref="Maintenance_HistoryController"/>
        /// </summary>
        /// <param name="repository"></param>
        public Maintenance_HistoryController(IMaintenance_HistoryRepository repository, ILogger<Maintenance_HistoryController> logger)
        {
        ...
        /// <summary>
        /// Servicio encargado de crear una Dates
        /// </summary>
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Create(Maintenance_History data)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update(int id, Maintenance_History data)
        {
            if (id < 0)
