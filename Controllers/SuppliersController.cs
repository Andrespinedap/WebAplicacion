...
namespace WebAplicacion.Controllers
{
    ...
    public class SuppliersController : ControllerBase
    {
        ...
        /// </summary>
        private readonly ISuppliersRepository repository;
        /// <summary>
        ...
        /// <summary>
        /// Constructor para la clase <see cref="SuppliersController"/>
        /// </summary>
        /// <param name="repository"></param>
        public SuppliersController(ISuppliersRepository repository, ILogger<SuppliersController> logger)
        {
        ...
        /// <summary>
        /// Servicio encargado de crear una Suppliers
        /// </summary>
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Create(Suppliers data)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update(int id, Suppliers data)
        {
            if (id < 0)
