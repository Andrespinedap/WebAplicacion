...
namespace WebAplicacion.Controllers
{
    ...
    public class InventoryController : ControllerBase
    {
        ...
        /// </summary>
        private readonly IxInventoryRepository repository;
        /// <summary>
        ...
        /// <summary>
        /// Constructor para la clase <see cref="InventoryController"/>
        /// </summary>
        /// <param name="repository"></param>
        public InventoryController(IxInventoryRepository repository, ILogger<InventoryController> logger)
        {
        ...
        /// <summary>
        /// Servicio encargado de crear una Inventory
        /// </summary>
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Create(Inventory data)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update(int id, Inventory data)
        {
            if (id < 0)
