...
namespace WebAplicacion.Controllers
{
    ...
    public class CitiesController : ControllerBase
    {
        ...
        /// <summary>
        /// Constructor para la clase <see cref="CitiesController"/>
        /// </summary>
        /// <param name="repository"></param>
        public CitiesController(ICitiesRepository repository, ILogger<CitiesController> logger)
        {
        ...
        /// <summary>
        /// Servicio encargado de crear una Cities
        /// </summary>
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Create(Cities data)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Update(int id, Cities data)
        {
            if (id < 0)
