...
namespace WebAplicacion.Controllers
{
    ...
    public class PaymentsController : ControllerBase
    {
        ...
        /// </summary>
        private readonly IPaymentsRepository repository;
        /// <summary>
        ...
        /// <summary>
        /// Constructor para la clase <see cref="PaymentsController"/>
        /// </summary>
        /// <param name="repository"></param>
        public PaymentsController(IPaymentsRepository repository, ILogger<PaymentsController> logger)
        {
        ...
        /// <summary>
        /// Servicio encargado de crear una Payments
        /// </summary>
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> Create(Payments data)
        {
